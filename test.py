...
# filePath = io.getUnprocessedFilePath('test.txt')
...
#
# result = json.loads(dic['data']['extraction_tags'])
# print(type(result),result)
#
# print('------------------------------')
# result = tag_the_article.getOriginTagList(dic['data']['extraction_tags'])
# print(result)


#
# html = """<p>昔日美国科技圈“最有权势的华人”、曾担任微软全球执行副总裁的陆奇博士（Dr. Qi Lu）终于有了新的消息。</p>\n<p>2017年1月17日，百度宣布任命陆奇担任百度集团总裁兼首席运营官。</p>\n<p>根据百度官方发布的公告，陆奇将主要负责百度的产品、技术、销售及市场运营。百度现有各业务群组负责人——包括搜索公司总裁向海龙、同为微软出身的技术体系和新兴业务群组总裁张亚勤、金融业务群组高级副总裁朱光、无人驾驶事业部高级副总裁王劲，以及负责人工智能技术团队首席科学家吴恩达，都将向陆奇汇报工作。</p>\n<p>这意味着陆奇成为了百度有史以来权力最大的职业经理人，他将主导百度这家公司的所有的具体业务——无论是成熟的搜索业务，还是金融、无人驾驶和人工智能等新兴业务的发展。他的职责范围大于2004-2007年间担任百度首席运营官、负责公司内部运营的朱洪波；远大于曾在2008-2010年间担任百度首席运营官，但实际只具体负责销售体系的叶朋；也明显大于2014年9月加盟百度担任总裁，后来又改任技术体系和新兴业务群组总裁的张亚勤。而这同时意味着：<strong>百度创始人、董事局主席兼CEO李彦宏将放权，不再直接负责具体业务。</strong></p>\n<p><b>陆奇加入百度，也是中国互联网公司职业经理人的最高配置。</b>此前，没有任何一家中国互联网公司的职业经理人，来自美国科技巨头的核心管理团队。从资历和经验上看，陆奇足以驾驭百度现有的高级管理团队。2016年9月，陆奇从微软全球执行副总裁的位置上离职，在离职前，他和 2013 年升任微软全球执行副总裁的沈向洋（Harry Shum）同一职级，直接向微软 CEO 萨特亚·纳德拉（Satya Nadella ）汇报，是纳德拉的核心智囊团。</p>\n<p><img class=\"size-full wp-image-100295 aligncenter\" src=\"http://cdn.pingwest.com/wp-content/uploads/2017/01/luqi.jpg?imageView2/2/w/750/q/90\" alt=\"luqi\" width=\"670\" height=\"447\" /></p>\n<p>跟这次加入百度负责多个产品业务条线的情况相同，陆奇在微软也是管理产品业务条线最多的高管，负责三大事业群之一的应用与服务集团（ASG），管理 Office、Office 365、SharePoint、Exchange、Yammer、Skype、Lync、MSN、广告平台和必应（Bing）搜索等大小产品。在新任微软 CEO 萨特亚·纳德拉上任提出的“移动为先”“云为先”的战略后，陆奇还成为纳德拉最重要的助手，主导微软原来以软件形态存在的产品，向互联网和云端转型。</p>\n<p>在就任后发给全体员工的第一封备忘录里，微软CEO纳德拉只提到了5个人，其中有微软创始人比尔 盖茨（Bill Gates）、前任CEO 史蒂夫 鲍尔默（Steve  Balmer ）、微软新任董事会主席约翰 汤普森（John Thompson），还有著名诗人奥斯卡 王尔德（Oscar Wilde），此外的另一个人就是陆奇。“陆奇在最近的一次会议上说得很好，微软正在用独特的方式帮助人们做得更多”，纳德拉写道。被与微软的创始人、董事会主席、前任CEO和著名诗人相提并论，这是陆奇在微软的最巅峰时刻。也正是通过这封备忘录，人们知道了正是陆奇，帮微软新任CEO纳德拉明确了公司新的重心，制定了微软业务向云和移动倾斜的战略。此后，微软以一个前所未有的“开放”形象，出现在了人们的面前。</p>\n<p>然而“巅峰”过后不到3年，陆奇即离开了微软。未经确认的消息称陆奇曾在微软高层内部力主收购硅谷最流行的、估值超过50亿美元的协同办公工具Slack——它颇为符合微软当下关注移动、云服务和办公效率的战略，但这一建议被CEO纳德拉和微软创始人盖茨否决。此后微软模仿Slack推出了自己的协同办公软件Teams，但用户数和普及程度远不如Slack。据说此事令陆奇与微软核心管理层之间产生了隔阂。此后，陆奇以“腿部受伤”为理由离开了微软。</p>\n<p>据PingWest品玩了解，陆奇从微软离职后，中国的互联网公司百度、腾讯、滴滴和今日头条等都曾与陆奇有过不同程度的接触和沟通。2016年10月，有媒体称陆奇即将加入腾讯担任联席总裁，与负责腾讯投资并购和公司战略的总裁、出身高盛的刘炽平并列。现在，陆奇正式加入了百度，成了百度仅次于李彦宏之外最有权势的高管。</p>\n<p>1961年生于上海的陆奇，在上个世纪90年代初即赴美深造，1996年在卡内基梅隆大学获得博士学位，同年加入IBM，1998年加入雅虎，并在2007年被任命为雅虎执行副总裁；2008年，时任微软CEO鲍尔默亲自延揽陆奇加入微软，出任互联网业务部门总经理，后擢升为微软全球资深副总裁、执行副总裁，成为最核心的管理团队成员。据媒体报道，陆奇通常凌晨3点起床查收邮件，晨跑4英里，然后到办公室工作。生性并不张扬的陆奇从不羞于对他人提及自己每天只睡4个小时，也经常把自己跟同事的会议时间定在晚上9点。</p>\n<p>这个经常被同事和同行形容为“谦虚”、“平易近人”和“友善”的人，自己却认为在工作上颇难与人相处。他自嘲是那种有工作洁癖、在演讲前的最后一刻不断地修改幻灯片和演讲稿的人。</p>\n<p>严谨、勤奋得甚至苛刻的陆奇加入百度，对这么一家处于焦虑和转型中的中国互联网巨头来说，具有着别样的意义，就像他当年加入亟待从“卖软件”的舒适区里爬出来，变成一家以移动和云为优先级战略的互联网公司那样。此刻的百度，亟需在人工智能领域奠定和巩固它的地位，走出互联网搜索引擎和关键字广告的舒适区——同时摆脱它在搜索广告领域累积下来的争议、批评、质疑和某种程度的“原罪”。</p>\n<p>一夜之间，美国科技圈“最有权势的华人”接管了百度。可能，这会是一个新的开始，把百度的现在的这篇儿，赶紧地翻过去。</p>\n<p>题图来自：Recode\n<p class=\"post-footer-wx\"><img src=\"http://cdn.pingwest.com/wp-content/themes/pingwest201603/images/pingwest_userwx.png\"><span class=\"qr-des\"><span><b>限量开放入群申请……</b></span><span>PingWest品玩的老朋友了？何不扫码加客服进群聊</span></span></p>\n"""
#
#
#
# print(webpage.extractContentBetweenTags(html))
